      ...
      />
        {
          ...
          blogCounter?.map((blog) => {
            return blog?(
              ...
              <Link to={`/blog/0/${blog._id}`} className='flex flex-col border-2 border-black rounded-md  p-[2vh] bg-white h-[35vh]'>    
                <div className='h-[20vh] w-[20vh] max-w-[30vmin] bg-cover self-center bg-center' style={blog.blogImg ? { backgroundImage: `url(${blog.blogImg})` } : { backgroundImage: `url(https://res.cloudinary.com/mohitproject/image/upload/v1706437260/Assets/dfx6zvd7elnqlyaa4cxi.png)` }}></div>
